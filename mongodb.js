//  /Users/mubarok/Programming/mongoDB/mongosh-2.0.1-darwin-arm64/bin/mongosh "mongodb://localhost:27017/test"
...
db.customers.bulkWrite([
    ...
    },
    {
        updateMany: {
            filter: {
                _id: {
                    $in: ['fikri', 'husni', 'mubaroq']
                }
            },
            update: {
                $set: {
                    full_name: 'Fikri Mubaroq'
                }
            }
        }
    }
...
"mongodb://fikri:fikri@localhost:27017/test?authSource=admin"
